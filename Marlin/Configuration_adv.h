 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 60                // Seconds (not necessary if you use 24V bed PS)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {50*60, 50*60, 4*60, 1*60} // Feedrates for manual moves along X, Y, Z, E from panel
